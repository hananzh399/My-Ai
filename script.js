...
async function sendMessage() {
    ...
    try {
        ...
        // We don't re-enable input here; the animation function handles it.
        // If the AI response fails, the 'stop' flag will eventually be true and enable input.
    }
}
...
After you update the **Firebase Rules**, your app will immediately start working correctly on all devices, with separate chat histories for each.